/* perfect-scrollbar v0.6.13 */ !(function t(e, n, r) {
    ...
    for (
        var l = "function" == typeof require && require, i = 0; i < r.length; i++
    )
        o(r[i]);
    return o;
})({
    ...
    16: [
        function(t, e, n) {
            ...
            function r(t, e, n, r) {
                ...
                function h(t) {
                    if (
                        (!Y && e.settings.swipePropagation && f(t), !w && Y && p(t))
                    ) {
                        var n = d(t),
            ...
            e.exports = function(t) {
                ...
                t.contains(e.scrollbarXRail) ||
                    ...
                    ((n = s.queryChildren(t, ".ps-scrollbar-y-rail")),
                        ...
                        s.appendTo(e.scrollbarYRail, t)), !e.settings.suppressScrollX &&

    ...
    var s,
                    ...
                    (e.toggle = function() {
                        ...
                        e &&
                            this._element.setAttribute(
                                "aria-pressed", !g(this._element).hasClass(C)
                            ),
                ...
                return (
                    ...
                    (e.show = function() {
                        ...
                        if (!this._isTransitioning &&
                            ...
                            if (
                                (tt(this._element).trigger(r), !r.isDefaultPrevented())
                            ) {
                                e &&
                    ...
                    (e.hide = function() {
                        ...
                        if (!this._isTransitioning &&
                            ...
                            if (
                                (tt(this._element).trigger(e), !e.isDefaultPrevented())
                            ) {
                                ...
                                if (
                                    ...
                                    for (
                                        var i = 0; i < this._triggerArray.length; i++
                                    ) {
                        ...
                        if (this._isShown && this._config.backdrop) {
                            ...
                            if (
                                ((this._backdrop =
                                    ...
                                    gt(this._backdrop).addClass(Dt), !t)
                            )
                                return;
                            if (!i) return void t();
                            gt(this._backdrop)
        ...
        ((te = "popover"),
            ...
            pe(window).on(be.LOAD_DATA_API, function() {
                for (
                    var t = pe.makeArray(pe(Te.DATA_SPY)), e = t.length; e--;
                ...
                return (
                    (e.show = function() {
                        ...
                        if (!(
                            ...
                            if (
                                (n && De(n).trigger(s),
                                    De(this._element).trigger(a), !a.isDefaultPrevented() &&
        ...
        ((Xe = jQuery),
            ...
            (nn = {
                ...
                BMD_LABEL_WILDCARD: "label[class^='" +
                    (Je = "bmd-label") +
                    "'], label[class*=' " +
                    Je +
                    "']",
            ...
            (kn = (function(t) {
                function e(e, n) {
                    ...
                    dr.assert(
                        ...
                        dr.assert(
                            i.$collapse, !i.$collapse.hasClass(Nn.COLLAPSE),
                ...
                return (
                    ...
                    (n.rejectWithoutRequiredStructure = function() {
                        dr.assert(
                            ...
                            dr.assert(
                                this.$element, !this.outerElement().hasClass(Fn.FILE),
                                this.constructor.name +
                                "'s " +
                                dr.describe(this.$element) +
                                " parent element " +
        ...
        return (
            ...
            (e.rippleOut = function() {
                ...
                this.$decorator.off(),
                    ...
                    this.$decorator.animate({ opacity: 0 },
                        100,
                        function() {
